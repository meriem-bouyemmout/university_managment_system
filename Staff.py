...
class StaffWindow :
    def __init__(self):
        ...
        self.job = ttk.Combobox(self.Frameleft,text='job', fg='#4F4F4F', font=('tahoma',12,'bold'), textvariable = self.jb)
        ...
        self.Phone = Entry(self.Frameleft,text='Phone', fg='#4F4F4F', values=["Chef departemment", "Chef de service", "Secrétère", "Ingénieur", "Technicien", "Prof", "Agent", "Employé"], font=('tahoma',12,'bold'), textvariable = self.ph)
